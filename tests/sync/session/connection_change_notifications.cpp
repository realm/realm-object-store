...
// FIXME [CM] Test cases disabled as it is unclear how to change connection state without a real integration test.
// The below works locally but not on CI. The reason for this is unclear, but perhaps it is timing related.
