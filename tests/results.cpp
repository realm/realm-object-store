...
TEST_CASE("BindingContext is notified about delivery of change notifications") {
    ...
    SECTION("notify BindingContext if no callbacks have been registered - local commit") {
    ...
    SECTION("notify BindingContext if no callbacks have been registered - remote commit") {
        static int binding_context_start_notify_calls = 0;
        static int binding_context_end_notify_calls = 0;
        struct Context : BindingContext {
            void will_send_notifications() override
    ...
    SECTION("notify BindingContext before and after sending notifications from local commits") {
        static int binding_context_start_notify_calls = 0;
        static int binding_context_end_notify_calls = 0;
        static int notification_calls = 0;

        // Register normal notification callbacks
    ...
    SECTION("notify BindingContext before and after sending notifications from remote commits") {
        static int binding_context_start_notify_calls = 0;
        static int binding_context_end_notify_calls = 0;
        static int notification_calls = 0;
        ...
        // Register normal notification callbacks
        Results results1(r, table->where().greater_equal(0, 0));
        Results results2(r, table->where().less_equal(0, 10));
