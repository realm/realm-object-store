...
if(REALM_HAVE_CONFIG)
    set(MAKE_ENV_VARS ${MAKE_ENV_VARS} REALM_HAVE_CONFIG=1)
endif()

if(SANITIZE_ADDRESS)
    set(MAKE_ENV_VARS ${MAKE_ENV_VARS} MAKEFLAGS='EXTRA_CFLAGS=-fsanitize=address EXTRA_LDFLAGS=-fsanitize=address')
endif()
...
function(clone_and_build_realm_core branch)
    ...
    ExternalProject_Add(realm-core
        ...
        BUILD_IN_SOURCE 1
        CONFIGURE_COMMAND ""
        BUILD_COMMAND ${MAKE_ENV_VARS} make -C src/realm librealm.a librealm-dbg.a
        INSTALL_COMMAND ""
        ${USES_TERMINAL_BUILD}
        )
