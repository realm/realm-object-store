...
macro(build_realm_sync core_prefix)
    set(sync_prefix_directory "${CMAKE_CURRENT_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/realm-sync")
    set(sync_config_options -DREALM_BUILD_TESTS=NO -DREALM_BUILD_COMMANDLINE_TOOLS=NO -G Ninja)
    ...
    ExternalProject_Add(realm-sync-lib
        ...
        CONFIGURE_COMMAND ${CMAKE_COMMAND} -E make_directory build.debug
                        && cd build.debug
                        && cmake -D CMAKE_BUILD_TYPE=Debug -D REALM_CORE_BUILDTREE=${core_prefix}/build.debug ${sync_config_options} ..
                        && cd ..
                        && ${CMAKE_COMMAND} -E make_directory build.release
                        && cd build.release
                        && cmake -D CMAKE_BUILD_TYPE=RelWithDebInfo -D REALM_CORE_BUILDTREE=${core_prefix}/build.release ${sync_config_options} ..
...
function(build_existing_realm_sync core_directory sync_directory)
    ...
    build_realm_sync(${core_directory}
                     URL ""
...
function(clone_and_build_realm_sync branch)
    ...
    build_realm_sync(${cmake_files}/realm-core/src/realm-core
