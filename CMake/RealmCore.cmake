...
elseif(CMAKE_SYSTEM_NAME MATCHES "^Windows")
    ...
    if(NOT EXISTS ${CMAKE_BINARY_DIR}/openssl/lib/cmake/OpenSSL/OpenSSLConfig.cmake)
        set(OPENSSL_URL "http://static.realm.io/downloads/openssl/1.1.1b/Linux/x86_64/openssl.tgz")
        if(REALM_PLATFORM STREQUAL "Android")
            set(OPENSSL_URL "http://static.realm.io/downloads/openssl/1.1.1b/Android/${ANDROID_ABI}/openssl.tgz")
        endif()
...
macro(build_realm_core)
    ...
    ExternalProject_Add(realm-core
        ...
        CONFIGURE_COMMAND cmake -B build.debug -DOpenSSL_DIR="${CMAKE_BINARY_DIR}/openssl/lib/cmake/OpenSSL" -D CMAKE_BUILD_TYPE=Debug ${CORE_SANITIZER_FLAGS} -G Ninja
                       && cmake -B build.release -DOpenSSL_DIR="${CMAKE_BINARY_DIR}/openssl/lib/cmake/OpenSSL" -D CMAKE_BUILD_TYPE=Debug ${CORE_SANITIZER_FLAGS} -G Ninja
...
macro(build_realm_sync)
    ...
    ExternalProject_Add(realm-sync-lib
        ...
        UPDATE_DISCONNECTED 1
        INSTALL_COMMAND ""
        CONFIGURE_COMMAND cmake -B build.debug -DCMAKE_BUILD_TYPE=Debug -DREALM_CORE_BUILDTREE=${core_directory}/build.debug ${sync_cfg_args}
                       && cmake -B build.release -DCMAKE_BUILD_TYPE=RelWithDebInfo -DREALM_CORE_BUILDTREE=${core_directory}/build.release ${sync_cfg_args}
